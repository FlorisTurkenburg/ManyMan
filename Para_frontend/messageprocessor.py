...
class MessageProcessor:
    ...
    def process_server_init(self, msg):
        ...
        if 'frequency_tables' in msg:
            self.comm.manyman.settings['frequency_table_A7'] = msg['frequency_tables'][0]
            self.comm.manyman.settings['frequency_table_A15'] = msg['frequency_tables'][1]

        if 'voltages' in msg:
            self.comm.manyman.eCore_voltage = msg['voltages'][1]
    ...
    def process_status(self, msg):
        ...
        for task in msg['chip']['Tasks']:
            if mm.has_task(task['ID']):
                ...
                elif not task['Status'] in ["Finished", "Failed", "Killed"] and \
            ...
            if not task['Status'] in ["Finished", "Failed", "Stopped", "Killed"]:
        ...
        mm.cpu_temperature = msg['chip']['Temperature']
